...
const wrapper = ({ children }: { children: React.ReactNode }) => <FeedbackPressProvider initialValue={{ vibrate: true }}>{children}</FeedbackPressProvider>
